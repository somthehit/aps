...
It is my extreme privilege and honor to serve as the Principal of Shree Alankar Public School, Punarbas-8, Prithvibasti, Kanchanpur. Ever since our inception in 2066 BS, our school has continuously grown from a modest private school into a quality educational institution for students from PG to Grade 8, providing creative and value-based education.

We prioritize an active integration of digital literacy, computer labs, audio-visual rooms, physical sports, transportation, day boarding and ECA activities which draw inspiration from our rich Nepalese identity.

We are highly grateful to the local government of Punarbas Municipality, our hard-working faculty members, and the collaborative School Management Committee (SMC) who support our operations. We welcome all parents to maintain open communicative relationships with us.
...
कञ्चनपुर जिल्लाको पुनर्वास नगरपालिकास्थित श्री अलंकार पब्लिक स्कूलको प्रधानाध्यापकका रूपमा यहाँहरूसँग जोडिन पाउँदा म अत्यन्तै गौरवान्वित छु। वि.सं. २०६६ सालमा सामान्य प्राथमिक पाठशालाको रूपमा स्थापना भएको यो विद्यालय आज क्षेत्रकै उत्कृष्ट सामुदायिक माध्यमिक विद्यालय बन्न सफल भएको छ।
...
धन्यवाद। यहाँहरू सबैको शैक्षिक यात्रा सुखद र सफल रहोस्।` },
    ...
    { key: 'established_year_bs', value: '2066' },
    { key: 'phone', value: '099422015, 9801701958' },
    { key: 'email', value: 'alankarpublicschool@gmail.com' },
    { key: 'address_en', value: 'Punarbas-8, Prithvibasti, Kanchanpur, Nepal' },
    { key: 'address_np', value: 'पुनर्वास-८, पृथ्वीबस्ती, कञ्चनपुर, नेपाल' },
    { key: 'emis', value: '720120015' },
  ]).onConflictDoNothing();

  // Seed notices
  await db.insert(notices).values([
    {
      title_en: 'Admission Open for PG to Eight (Academic Year 2081 BS)',
      title_np: 'कक्षा १-१० को लागि भर्ना खुला (शैक्षिक वर्ष २०८१)',
      content_en: 'Shree Alankar Public School is pleased to announce that admissions are now open for the academic year 2081 BS for all classes from PG to Grade 8. Interested candidates are requested to visit the school office with relevant documents.',
      content_np: 'श्री अलंकार पब्लिक स्कूलले सूचित गर्दछ कि शैक्षिक वर्ष २०८१ को लागि कक्षा १ देखि १० सम्मका सबै कक्षाहरूमा भर्ना खुला भएको छ।',
      category: 'admission',
      is_pinned: true,
    },
    {
  ...
  await db.insert(milestones).values([
    {
      ...
      date_label: '२०६६',
      year_ad: '2009',
      description_en: 'Shree Alankar Public School was established in Punarbas-8, Prithvibasti, Kanchanpur with the mission of providing quality education to the local private.',
      description_np: 'श्री अलंकार पब्लिक स्कूल पुनर्वास-८, पृथ्वीबस्ती, कञ्चनपुरमा स्थानीय समुदायलाई गुणस्तरीय शिक्षा प्रदान गर्ने उद्देश्यले स्थापित भएको थियो।',
      display_order: 1,
    },
    {
  ...
  await db.insert(staff).values([
    {
      name_en: 'Pusp Raj Ojha',
      name_np: 'पुष्प राज ओझा',
      role_en: 'Principal',
