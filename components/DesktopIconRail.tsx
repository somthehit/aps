...
export default function DesktopIconRail() {
  ...
  return (
    <motion.aside
      className="hidden md:flex fixed top-0 left-0 h-screen z-40 bg-[#1a2d5a] text-white flex-col border-r border-[#d4af37] shadow-xl no-print"
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center py-6 border-b border-[#c0392b]/30 h-[120px] shrink-0">
        <Link href="/" className="flex items-center gap-3">
          ...
          {isExpanded && (
            ...
            >
              <span className="text-[#c0392b] text-sm font-bold uppercase tracking-wider mb-1">Shree Alankar</span>
              <span className="text-white text-xs font-medium opacity-90 mb-1">Public School</span>
              {settings.emis && (
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-4 py-3 px-3 rounded-lg transition-all duration-200 relative group cursor-pointer ${
                isActive
                  ? "bg-[#c0392b]/20 text-[#e57373] font-semibold border-l-4 border-[#c0392b]"
            ...
            >
              ...
              {isExpanded ? (
                ...
                <span className="absolute left-16 bg-[#0d1b33] text-[#c0392b] text-xs py-1 px-2.5 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-[#c0392b]/25 z-50">
                  {t(item.labelEn, item.labelNp)}
                </span>
              )}
            </Link>
      ...
      <div className="p-3.5 border-t border-[#c0392b]/30 flex flex-col gap-2 shrink-0">
        {/* Language Switcher */}
        <button
        ...
        >
          <Globe className="w-5 h-5 shrink-0 text-[#c0392b]" />
          {isExpanded ? (
            <motion.span
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <span className="absolute left-16 bg-[#0f1e3d] text-[#d4af37] text-xs py-1 px-2.5 rounded shadow-lg opacity-0 hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap border border-[#d4af37]/25 z-50">
        ...
        <Link
          href="/admin/login"
          className="flex items-center gap-4 py-2.5 px-3 rounded-lg text-white/50 hover:bg-[#c0392b]/25 hover:text-[#e57373] transition-all cursor-pointer"
        >
