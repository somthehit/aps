...
export const metadata: Metadata = {
  title: {
    template: "%s | Shree Alankar Public School",
    default: "Shree Alankar Public School | Kanchanpur, Nepal",
  },
  description: "Official website of Shree Alankar Public School. Punarbas-8, Prithvibasti, Kanchanpur, Nepal. Established in 2066 BS.",
};
