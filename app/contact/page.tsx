        ...
        <div className="md:col-span-2 flex flex-col gap-5">
          <div className="bg-white border border-[#c9a227]/30 rounded-lg p-5 shadow-sm parchment-glow flex items-start gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-[#444444] leading-relaxed mt-1 font-sans">
                {t("Punarbas-8, Prithvibasti, Kanchanpur District, Sudurpaschim Province, Nepal", "पुनर्वास-८, पृथ्वीबस्ती, कञ्चनपुर जिल्ला, सुदूरपश्चिम प्रदेश, नेपाल")}
              </span>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#c9a227]/30 rounded-lg p-5 shadow-sm parchment-glow flex items-start gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-[#444444] leading-relaxed mt-1 font-sans">
                {t("099422015 (General)", "०९९४२२०१५ (प्रशासन शाखा)")}
                <br />
                {t("9801701958 (Principal Desk)", "९८०१७०१९५८ (प्रधानाध्यापक कक्ष)")}
              </span>
            </div>
          </div>
          ...
          {isSubmitted ? (
            <div className="text-center py-10 flex flex-col items-center">
              ...
              <p className="text-xs sm:text-sm text-[#444444]/80 mt-2 font-sans max-w-sm">
                {t(
                  "Thank you for contacting Shree Alankar Public School. Our school administrators will review your inquiry shortly.",
