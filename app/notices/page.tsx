      ...
      .then(json => {
        ...
        if (s.phone || s.email || s.emis || s.school_code) {
          setSchoolInfo({
            ...
            email: s.email || 'alankarpublicschool@gmail.com',
            emis: s.emis || '720120015',
            schoolCode: s.school_code || 'SC-0000',
            addressEn: s.address_en || 'Punarbas-8, Prithvibasti, Kanchanpur, Nepal',
    ...
    return `
      <div style="max-width:700px;margin:40px auto;font-family:Georgia,serif;color:#1a3a2a;">
        <div style="text-align:center;border-bottom:2px solid #1a3a2a;padding-bottom:16px;margin-bottom:24px;">
          <h1 style="font-size:22px;font-weight:bold;margin:0;text-transform:uppercase;">Shree Alankar Public School</h1>
      ...
      {printNoticeId && (
        <div className="print-formatted">
          ...
          <div className="text-center border-b-2 border-[#1a3a2a] pb-4 mb-6">
            <h1 className="text-2xl font-bold font-serif text-[#1a3a2a] uppercase">Shree Alankar Public School</h1>
